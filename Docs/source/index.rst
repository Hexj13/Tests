...
Даннаая инструкция направлена на быстрое понимание принципов работы с библитекой **RootLib**,
структуры теста и необходимых инструменов для комфортной работы.

.. note:: Вы можите воспользоваться Поиском для быстрого поиска информации
...
Инструменты
-----------
Для тестирования платфомы **Flexbby** используется связка Python 3 + Selenuim.
...
* Если имя теста состоит из нескольких слов, то эти слова должны быль заделены знаком "_".
...
addLinkage
~~~~~~~~~~
Данная функция используется для добавления связи в документ в системе Flexbby.
...
Функция сама перейдёт в райздел, найдёт ссылку, нажмёт кнопку "Удалить" и нажмёт "ОК"
